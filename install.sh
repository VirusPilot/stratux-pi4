...
source /root/.bashrc
cp -f /root/stratux-pi4/__lib__systemd__system__stratux.service /root/stratux/__lib__systemd__system__stratux.service
cp -f /root/stratux-pi4/__root__stratux-pre-start.sh /root/stratux/__root__stratux-pre-start.sh
